...
**记录**：在今日代办表格下方，填上待办事项(如果是计划外的紧急事件)；
  在今日代办表格当前活动的右边，画一个撇号(-)。
1. 告知：我手头有事，正忙
2. 协商：周五再帮你做，行吗
3. 计划：写下活动名称，稍后为它计划番茄时钟
4. 答复：按照承诺回复。
###预估
承诺是番茄工作法的核心。“今日待办”表格是每天的承诺，所选出的活动应当具有可行性。工作的总量应当是你通常在一天之内能完成的。
预估出现偏差的原因：
* 做预估的方法或能力有待改进
* 工作开始后，出现新情况、新问题，使得环境发生变化

####规模
假如一项活动预估超过7个番茄钟，说明它太复杂。需要拆分这项活动。拆分后的每项小活动在“活动清单”表格中独占一行，各自有预估的番茄钟。
如果一项活动预估不够一个番茄钟，则可以在旁标记为0.可以将几项这样的活动合并到一起，当作一个番茄钟。
...
* 任务进行时
  每完成一个番茄钟，在小方块中画一个X
  1. 所有方块填满X前或刚好填满X已经完成该任务
     划掉该任务
  2. 已经填满小方块但并没有完成该任务
     二次预估该任务需要的番茄钟，使用**圆圈**
     二次预估后任未完成时，使用**三角**做三次预估
  三次预估后还没有完成任务，应当重新审视这个任务
